...
function BootstrapModalAppointmentAdmin({ appointmentData }) {
  ...
  const handleClose = () => {
    ...
    navigate("/");
    setTimeout(() => {
      navigate("/appointment-admin"); //Nos lleva a appointment
...
export default BootstrapModalAppointmentAdmin;
